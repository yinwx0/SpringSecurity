        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/spring_security?zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&autoReconnect=true",
                ...
                .globalConfig(builder -> {
                    ...
                    builder.author("wxyin")
                            ...
                            .fileOverride()
                            // 指定 Java 代码输出目录
                            .outputDir("C:/Users/Lenovo/Desktop/SpringSecurity/5-auth-password-encoder/src/main/java");
                })
                .packageConfig(builder -> {
                    // 设置父包名
                    builder.parent("top.wxyin")
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "C:/Users/Lenovo/Desktop/SpringSecurity/5-auth-password-encoder/src/main/resources/mapper")); // 设置 mapperXml 生成路径
                })
